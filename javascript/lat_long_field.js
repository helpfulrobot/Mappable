function setMarker(location){
         ...
         function setCoordByMarker(event) {
            JQ('input[name=Latitude]').val(event.latLng.lat());
            JQ('input[name=Longitude]').val(event.latLng.lng());
      ...
      /*
        ...
        */
        ...
        function initMap () {
            ...
            map = new google.maps.Map(document.getElementById("#geocode_map_Form_EditForm_LatitudeLongitude"), myOptions);
